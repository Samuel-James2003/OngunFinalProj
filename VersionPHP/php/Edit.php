...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['Edit'])) {
        ...
        $isDoneClient = isset($_POST["isDoneClient"])?$_POST["isDoneClient"]:0;
        $isDoneWorker = isset($_POST["isDoneWorker"])?$_POST["isDoneWorker"]:0;
        $isDone = isset($_POST["isDone"])?$_POST["isDone"]:0;
